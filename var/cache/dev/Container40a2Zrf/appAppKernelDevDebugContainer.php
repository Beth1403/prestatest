    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'modules_translation_paths' => [
                ...
                11 => (\dirname(__DIR__, 4).'/modules/productcomments/translations'),
                12 => (\dirname(__DIR__, 4).'/modules/ps_categorytree/translations'),
                13 => (\dirname(__DIR__, 4).'/modules/dashactivity/translations'),
                14 => (\dirname(__DIR__, 4).'/modules/dashgoals/translations'),
                15 => (\dirname(__DIR__, 4).'/modules/dashproducts/translations'),
                16 => (\dirname(__DIR__, 4).'/modules/dashtrends/translations'),
                17 => (\dirname(__DIR__, 4).'/modules/gridhtml/translations'),
                18 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
                19 => (\dirname(__DIR__, 4).'/modules/pagesnotfound/translations'),
