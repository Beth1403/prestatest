...
return $this->privates['PrestaShop\\PrestaShop\\Core\\Module\\SourceHandler\\RemoteZipSourceHandler'] = new \PrestaShop\PrestaShop\Core\Module\SourceHandler\RemoteZipSourceHandler(($this->services['prestashop.module.sourcehandler.zip'] ?? $this->load('getPrestashop_Module_Sourcehandler_ZipService.php')), ($this->privates['.debug.http_client'] ?? $this->get_Debug_HttpClientService()), (\dirname(__DIR__, 4).'/var/cache/prod'.\DIRECTORY_SEPARATOR.'/downloads'));
